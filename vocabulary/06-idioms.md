# 口语 idioms — Speaking 高分表达

> Speaking 评分中 "uses less common idiomatic vocabulary" 是 Band 7 的硬指标。
> **适度使用**，每个 part 1–2 个即可，不要堆砌。
...
| Touch wood / Knock on wood | 但愿如此 |
| Beat around the bush | 拐弯抹角 |
| Call it a day | 收工 |
| Hit the books | 用功学习 |
| Pull an all-nighter | 通宵 |
| Spread oneself too thin | 摊子铺得太大 |
